 ...
 * allowed to create.
 *
 * Evidence upload/attachment is now a gateway operation for the same
 * technical/manager/admin write roles. The UI guard mirrors that published
 * contract; the backend remains the authority.
 *
