  ...
  return (
    <section className="rounded-card border border-line-hair bg-card p-[20px]">
      ...
      <div className="mt-[14px] grid grid-cols-1 gap-[10px] sm:grid-cols-2">
        ...
        <input required type="email" value={value.email} onChange={(e) => update("email", e.target.value)} placeholder="Email công việc *" className="rounded-field border border-line-strong bg-deep px-[12px] py-[10px] text-[13px] text-ink placeholder:text-ink-faint" />
