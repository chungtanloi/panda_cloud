...
export const endpoints = {
  ...
  admin: {
    ...
    auditById: (id: string) => `/admin/audit-logs/${id}`,
    events: "/admin/integrations/events",
    eventById: (id: string) => `/admin/integrations/events/${id}`,
    organizations: "/admin/organizations",
    organizationById: (id: string) => `/admin/organizations/${id}`,
    memberships: (orgId: string) => `/admin/organizations/${orgId}/memberships`,
    membershipById: (orgId: string, membershipId: string) => `/admin/organizations/${orgId}/memberships/${membershipId}`,
  },
