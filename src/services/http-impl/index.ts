...
export const httpApi: ApiClient = {
  ...
  admin: {
    ...
    user: (id: string) => http.get<AdminUser>(endpoints.admin.userById(id)),
    updateUser: (id: string, body: AdminUserUpdateRequest) => http.patch<AdminUser>(endpoints.admin.userById(id), body),
    ...
    auditLog: (id: string) => http.get<AdminAuditRecord>(endpoints.admin.auditById(id)),
    ...
    organizations: (query = {}) => http.get<AdminOrganizationPage>(endpoints.admin.organizations, { query }),
    organization: (id: string) => http.get<AdminOrganizationDetail>(endpoints.admin.organizationById(id)),
    createOrganization: (body: AdminOrganizationCreateRequest) => http.post<AdminOrganizationSummary>(endpoints.admin.organizations, body),
    updateOrganization: (id: string, body: AdminOrganizationUpdateRequest) => http.patch<AdminOrganizationSummary>(endpoints.admin.organizationById(id), body),
    memberships: (orgId: string, query = {}) => http.get<AdminMembershipPage>(endpoints.admin.memberships(orgId), { query }),
    membership: (orgId: string, membershipId: string) => http.get<AdminMembership>(endpoints.admin.membershipById(orgId, membershipId)),
    createMembership: (orgId: string, body: AdminMembershipCreateRequest) => http.post<AdminMembership>(endpoints.admin.memberships(orgId), body),
    updateMembership: (orgId: string, membershipId: string, body: AdminMembershipUpdateRequest) => http.patch<AdminMembership>(endpoints.admin.membershipById(orgId, membershipId), body),
  },
